...
<?php  hooks()->do_action('document_client_head'); ?>
<div id="wrapper">
	<div class="content">
		<div class="panel_s">
				...
				<div class="modal fade" id="AddFolderModal" role="dialog">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<?php echo form_open_multipart(site_url('document/document_client/add_edit_folder_client'),array('id'=>'add-edit-folder-form'));?>
